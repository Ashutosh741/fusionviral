    ...
    <div class="cs-hero cs-style1 cs-bg cs-fixed_bg cs-shape_wrap_1" data-src="assets/img/hero_bg.jpe" id="home">  
      ...
      <div class="container">
        <div class="cs-hero_text">
          ...
          <div class="cs-hero_info">
            ...
            <div>
              <div class="cs-hero_subtitle"> We craft captivating content and strategic campaigns to make your brand shine in the digital world. Let's create social magic together! </div>
            </div>
          </div>
      ...
      <div class="cs-hero_social_wrap cs-primary_font cs-primary_color">
        ...
        <ul class="cs-hero_social_links">
          <li>
            <a href="https://www.facebook.com/fusionviralnews/">Facebook</a>
          </li>
          <li>
            <a href="https://www.instagram.com/_fusionviral/">Instagram</a>
          </li>
        </ul>
      </div>
          ...
          <div class="col-xl-8">
            <div class="row">
              ...
              <div class="col-lg-3 col-sm-6">
                <div class="cs-hobble">
                  <a href="Youtube.php" class="cs-card cs-style1 cs-hover_layer1">
                    ...
                    <div class="cs-card_info">
                      ...
                      <h2 class="cs-card_title">YOUTUBE Promotion</h2>
                    </div>
                  </a>
                </div>
              ...
              <div class="col-lg-3 col-sm-6">
                <div class="cs-hobble">
                  <a href="Instagram.php" class="cs-card cs-style1 cs-hover_layer1">
                    <img src="assets/img/service_2.jpeg" alt="Service">
                    <div class="cs-card_overlay"></div>
                    <div class="cs-card_info">
                      <span class="cs-hover_layer3 cs-accent_bg"></span>
                      <h2 class="cs-card_title">INSTAGRAM Promotion</h2>
                    </div>
                  </a>
                </div>
                <div class="cs-height_0 cs-height_lg_30"></div>
              ...
              <div class="col-lg-3 col-sm-6">
                <div class="cs-hobble">
                  <a href="Facebook.php" class="cs-card cs-style1 cs-hover_layer1">
                    <img src="assets/img/service_3.jpeg" alt="Service">
                    <div class="cs-card_overlay"></div>
                    <div class="cs-card_info">
                      <span class="cs-hover_layer3 cs-accent_bg"></span>
                      <h2 class="cs-card_title">FACEBOOK Promotion</h2>
                    </div>
                  </a>
                </div>
                <div class="cs-height_0 cs-height_lg_30"></div>
              ...
              <div class="col-lg-3 col-sm-6">
                <div class="cs-hobble">
                  <a href="Linkedin.php" class="cs-card cs-style1 cs-hover_layer1">
                    <img src="assets/img/service_4.jpeg" alt="Service">
                    <div class="cs-card_overlay"></div>
                    <div class="cs-card_info">
                      <span class="cs-hover_layer3 cs-accent_bg"></span>
                      <h2 class="cs-card_title">LINKEDIN Promotion</h2>
                    </div>
                  </a>
                </div>
                <div class="cs-height_0 cs-height_lg_30"></div>
  ...
  <section id="service">
    <div class="container">
      <div class="cs-section_heading cs-style1 text-center">
        <h3 class="cs-section_subtitle">Top Pickup Services</h3>
    ...
    <div class="container">
      <div class="cs-iconbox_3_list">
        <div class="cs-hover_tab active">
          <a href="Youtube.php" class="cs-iconbox cs-style3">
            <div class="cs-image_layer cs-style1 cs-size_md">
              <div class="cs-image_layer_in">
                <img src="assets/img/Yotubue-Promotion.png" alt="Image" class="w-100 cs-radius_15">
              </div>
            </div>
            ...
            <div class="cs-iconbox_in">
              <h2 class="cs-iconbox_title">Youtube Promotion</h2>
        ...
        <div class="cs-hover_tab">
          <a href="Instagram.php" class="cs-iconbox cs-style3">
            <div class="cs-image_layer cs-style1 cs-size_md">
              <div class="cs-image_layer_in">
                <img src="assets/img/Instagram-Promotion.png" alt="Image" class="w-100 cs-radius_15">
              </div>
            </div>
            <span class="cs-iconbox_icon cs-center">
              <svg width="30" height="29" viewBox="0 0 30 29" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="cs-iconbox_in">
              <h2 class="cs-iconbox_title">Instagram Promotion</h2>
              <div class="cs-iconbox_subtitle">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium lorema doloremque laudantium, totam rem.</div>
            </div>
          </a>
        </div>
        <div class="cs-hover_tab">
          <a href="Facebook.php" class="cs-iconbox cs-style3">
            <div class="cs-image_layer cs-style1 cs-size_md">
              <div class="cs-image_layer_in">
                <img src="assets/img/Facebook-Promotion.png" alt="Image" class="w-100 cs-radius_15">
              </div>
            </div>
            <span class="cs-iconbox_icon cs-center">
              <svg width="30" height="29" viewBox="0 0 30 29" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="cs-iconbox_in">
              <h2 class="cs-iconbox_title">Facebook Promotion</h2>
              <div class="cs-iconbox_subtitle">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium lorema doloremque laudantium, totam rem.</div>
            </div>
          </a>
        </div>
        <div class="cs-hover_tab">
          <a href="Linkedin.php" class="cs-iconbox cs-style3">
            <div class="cs-image_layer cs-style1 cs-size_md">
              <div class="cs-image_layer_in">
                <img src="assets/img/Linkedin-Promotion.png" alt="Image" class="w-100 cs-radius_15">
              </div>
            </div>
            <span class="cs-iconbox_icon cs-center">
              <svg width="30" height="29" viewBox="0 0 30 29" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="cs-iconbox_in">
              <h2 class="cs-iconbox_title">Linkedin Promotion</h2>
              <div class="cs-iconbox_subtitle">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium lorema doloremque laudantium, totam rem.</div>
            </div>
          </a>
        </div>
