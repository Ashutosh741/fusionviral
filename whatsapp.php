...
<div class="whatsapp-banner position-relative d-flex justify-content-center align-items-center">
...
<div class="container">
  <div class="cs-section_heading cs-style1 text-center">
    <h3 class="cs-section_subtitle">Promote <img src="assets/img/Whatsapp-Icon.png"></img></h3>
    <h3 class="cs-section_title">Whatsapp Marketing at your finger tips</h3><br>
    <h2 class="cs-section_subtitle">Whatsapp Marketing Tool</h2>
  </div>
  ...
  <div class="row">
    <div class="col-lg-48">
      <div class="cs-iconbox cs-style2 text-center">
        ...
        <h2 class="cs-iconbox_title">Desktop based</h2>
    ...
    <div class="col-lg-48">
      <div class="cs-iconbox cs-style2 text-center">
        ...
        <h2 class="cs-iconbox_title">Cloud based</h2>
        <div class="cs-iconbox_subtitle">Sed ut perspiciatis unde omnis iste natus error voluptatem accusantium also a
          doloremque laudantium, totam remain beatae vitae dictaro enim ipsam sunt explicabo.</div>
      </div>
      <div class="cs-height_30 cs-height_lg_35"></div>
    ...
    <div class="col-lg-48">
      <div class="cs-iconbox cs-style2 text-center">
        ...
        <h2 class="cs-iconbox_title">Android app</h2>
        <div class="cs-iconbox_subtitle">Sed ut perspiciatis unde omnis iste natus error voluptatem accusantium also a
          doloremque laudantium, totam remain beatae vitae dictaro enim ipsam sunt explicabo.</div>
      </div>
      <div class="cs-height_30 cs-height_lg_35"></div>
  ...
  <div class="row">
    <div class="col-lg-48">
      <div class="cs-iconbox cs-style2 text-center">
        ...
        <h2 class="cs-iconbox_title">Wapp API</h2>
        <div class="cs-iconbox_subtitle">Sed ut perspiciatis unde omnis iste natus error voluptatem accusantium also a
          doloremque laudantium, totam remain beatae vitae dictaro enim ipsam sunt explicabo.</div>
      </div>
      <div class="cs-height_30 cs-height_lg_35"></div>
    ...
    <div class="col-lg-48">
      <div class="cs-iconbox cs-style2 text-center">
        ...
        <h2 class="cs-iconbox_title">Auto Chat Bot</h2>
        <div class="cs-iconbox_subtitle">Sed ut perspiciatis unde omnis iste natus error voluptatem accusantium also a
          doloremque laudantium, totam remain beatae vitae dictaro enim ipsam sunt explicabo.</div>
      </div>
      <div class="cs-height_30 cs-height_lg_35"></div>
    ...
    <div class="col-lg-48">
      <div class="cs-iconbox cs-style2 text-center">
        ...
        <h2 class="cs-iconbox_title">Auto Wapp Groups</h2>
        <div class="cs-iconbox_subtitle">Sed ut perspiciatis unde omnis iste natus error voluptatem accusantium also a
          doloremque laudantium, totam remain beatae vitae dictaro enim ipsam sunt explicabo.</div>
      </div>
      <div class="cs-height_30 cs-height_lg_35"></div>
  ...
  <div class="row">
    <div class="col-lg-48">
      <div class="cs-iconbox cs-style2 text-center">
        ...
        <h2 class="cs-iconbox_title">Number Filter</h2>
        <div class="cs-iconbox_subtitle">Sed ut perspiciatis unde omnis iste natus error voluptatem accusantium also a
          doloremque laudantium, totam remain beatae vitae dictaro enim ipsam sunt explicabo.</div>
      </div>
      <div class="cs-height_30 cs-height_lg_35"></div>
    ...
    <div class="col-12 col-md-6 col-lg-6 why_buyL_ytbvws_Right">
      <div class="why_buyL_ytbvws_RightContent">
        ...
        <div class="why_buyL_ytbvws_txt">
          <h1 class="h1_responsive">The Power of Whatsapp Marketing Software</h1>
    ...
    <div class="col-12 col-md-6 why_buyF_ytbsbc_Right">
      <div class="why_buyF_ytbvws_RightContent">
        <div class="why_buyF_ytbvws_iconimg">
          <img src="assets/img/05.png" alt="Play Button">
        </div>
        <div class="why_buyF_ytbvws_txt">
          <h1 class="h1_responsive">How Will It Benefit You?</h1>
          <p>
...
<section class="why_buyL_ytbvws container">
  <div class="row">
    <div class="col-md-6 col-lg-6 order-2 order-md-1 why_buyL_ytbvws_Right">
      <div class="why_buyL_ytbvws_RightContent">
        <div class="why_buyL_ytbvws_iconimg">
          <img class="img-fluid" src="assets/img/05.png" alt="Play Button">
        </div>
        <div class="why_buyL_ytbvws_txt">
          <h1 class="h1_responsive">Benefits of Whatsapp Marketing</h1>
          <p>
