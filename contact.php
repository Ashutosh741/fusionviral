...
<!-- On Header Section End -->
      ...
      <div class="col-lg-6">
        ...
        <ul class="cs-contact_info cs-style1 cs-mp0">
          ...
          <li>
            ...
            <span>info@fusionviral.com</span>
          </li>
          <li>
            <svg width="14" height="20" viewBox="0 0 14 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M7 0C3.13 0 0 3.13 0 7C0 12.25 7 20 7 20C7 20 14 12.25 14 7C14 3.13 10.87 0 7 0ZM7 9.5C5.62 9.5 4.5 8.38 4.5 7C4.5 5.62 5.62 4.5 7 4.5C8.38 4.5 9.5 5.62 9.5 7C9.5 8.38 8.38 9.5 7 9.5Z" fill="#bb0000"></path>
            </svg>              
            <span>MB 160A, 4th Floor, Grover Complex,<br>Opp. Madhuban Park (Near Nirman <br>Vihar Metro Station),New Delhi – 110092</span>
          </li>
        </ul>
  ...
  <div class="cs-height_150 cs-height_lg_80"></div>
  <div class="mapouter"><div class="gmap_canvas"><iframe class="gmap_iframe" width="100%" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=2048&amp;height=570&amp;hl=en&amp;q=Lets Digital Marketing Agency, Nirman Vihar Metro Station, MB 160A, 4th Floor, Master Block Grover Complex, opp. Madhuban Park, Delhi, 110092&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe><a href="https://connectionsgame.org/">Connections Unlimited</a></div><style>.mapouter{position:relative;text-align:right;width:100%;height: 570px;}.gmap_canvas {overflow:hidden;background:none!important;width:100%;height:570px;}.gmap_iframe {height:570px!important;}</style></div></div>
