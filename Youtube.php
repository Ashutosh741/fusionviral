...
<source src="assets/videos/4k3.mp4" type="video/mp4">
  ...
  <div class="container">
    <div class="cs-page_heading_in">
      <h1 class="cs-page_title cs-font_50 cs-white_color2">Promote Your Youtube Videos <br>With Real Promotional <br>Services
      </h1>
...
<div class="container">
  <div class="cs-section_heading cs-style1 text-center">
    <h3 class="cs-section_subtitle">Promote <img src="assets/img/youtube-icon.png"></img></h3>
  ...
  <div class="row">
    <div class="col-lg-44">
      <div class="cs-iconbox cs-style2 text-center">
        ...
        <h2 class="cs-iconbox_title">Video Viewership</h2>
    ...
    <div class="col-lg-44">
      <div class="cs-iconbox cs-style2 text-center">
        ...
        <h2 class="cs-iconbox_title">Youtube Subscriber</h2>
        <div class="cs-iconbox_subtitle">Sed ut perspiciatis unde omnis iste natus error voluptatem accusantium also a
          doloremque laudantium, totam remain beatae vitae dictaro enim ipsam sunt explicabo.</div>
      </div>
      <div class="cs-height_30 cs-height_lg_35"></div>
    ...
    <div class="col-lg-44">
      <div class="cs-iconbox cs-style2 text-center">
        ...
        <h2 class="cs-iconbox_title">Youtube Likes</h2>
        <div class="cs-iconbox_subtitle">Sed ut perspiciatis unde omnis iste natus error voluptatem accusantium also a
          doloremque laudantium, totam remain beatae vitae dictaro enim ipsam sunt explicabo.</div>
      </div>
      <div class="cs-height_30 cs-height_lg_35"></div>
  ...
  <div class="row">
    <div class="col-lg-44">
      <div class="cs-iconbox cs-style2 text-center">
        ...
        <h2 class="cs-iconbox_title">Youtube Comment</h2>
        <div class="cs-iconbox_subtitle">Sed ut perspiciatis unde omnis iste natus error voluptatem accusantium also a
          doloremque laudantium, totam remain beatae vitae dictaro enim ipsam sunt explicabo.</div>
      </div>
      <div class="cs-height_30 cs-height_lg_35"></div>
    ...
    <div class="col-lg-44">
      <div class="cs-iconbox cs-style2 text-center">
        ...
        <h2 class="cs-iconbox_title">Channel Watch Hours</h2>
        <div class="cs-iconbox_subtitle">Sed ut perspiciatis unde omnis iste natus error voluptatem accusantium also a
          doloremque laudantium, totam remain beatae vitae dictaro enim ipsam sunt explicabo.</div>
      </div>
      <div class="cs-height_30 cs-height_lg_35"></div>
    ...
    <div class="col-lg-44">
      <div class="cs-iconbox cs-style2 text-center">
        ...
        <h2 class="cs-iconbox_title">Youtube Short</h2>
        <div class="cs-iconbox_subtitle">Sed ut perspiciatis unde omnis iste natus error voluptatem accusantium also a
          doloremque laudantium, totam remain beatae vitae dictaro enim ipsam sunt explicabo.</div>
      </div>
      <div class="cs-height_30 cs-height_lg_35"></div>
  ...
  <div class="row">
    <div class="col-lg-44">
      <div class="cs-iconbox cs-style2 text-center">
        ...
        <h2 class="cs-iconbox_title">Youtube Subscriptions</h2>
        <div class="cs-iconbox_subtitle">Sed ut perspiciatis unde omnis iste natus error voluptatem accusantium also a
          doloremque laudantium, totam remain beatae vitae dictaro enim ipsam sunt explicabo.</div>
      </div>
      <div class="cs-height_30 cs-height_lg_35"></div>
    ...
    <div class="col-12 col-md-6 col-lg-6 why_buyL_ytbvws_Right">
      <div class="why_buyL_ytbvws_RightContent">
        ...
        <div class="why_buyL_ytbvws_txt">
          <h1 class="h1_responsive">Why you should promote your Youtube videos?</h1>
    ...
    <div class="col-12 col-md-6 why_buyF_ytbsbc_Right">
      <div class="why_buyF_ytbvws_RightContent">
        ...
        <div class="why_buyF_ytbvws_txt">
          <h1 class="h1_responsive">How we deliver Views?</h1>
          <p>
...
<section class="why_buyL_ytbvws container">
  <div class="row">
    <div class="col-md-6 col-lg-6 order-2 order-md-1 why_buyL_ytbvws_Right">
      <div class="why_buyL_ytbvws_RightContent">
        <div class="why_buyL_ytbvws_iconimg">
          <img class="img-fluid" src="assets/img/play-button.png" alt="Play Button">
        </div>
        <div class="why_buyL_ytbvws_txt">
          <h1 class="h1_responsive">Is it safe to buy YouTube views for my videos?</h1>
          <p>
