...
<div class="container">
  <div class="cs-section_heading cs-style1 text-center">
    <h3 class="cs-section_subtitle">Our All Services </h3>
    <h2 class="cs-section_title">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Itaque rem esse numquam velit, consectetur eum sapiente quisquam ullam atque vel temporibus in. Dignissimos accusantium doloribus incidunt dolorum aperiam libero voluptate consectetur ut eos quaerat.</h2>
  </div>
  ...
  <div class="row">
    <div class="col-lg-44">
      <div class="cs-iconbox cs-style2 text-center">
        <div class="cs-iconbox_icon">
          <img src="assets/img/youtube-icon.png"></img>
        </div>
        <h2 class="cs-iconbox_title"><a href="Youtube.php">Youtube</a></h2>
    ...
    <div class="col-lg-45">
      <div class="cs-iconbox cs-style2 text-center">
        <div class="cs-iconbox_icon">
          <img src="assets/img/instagram-icon.png"></img>
        </div>
        <h2 class="cs-iconbox_title"><a href="Instagram.php">Instagram</a></h2>
        <div class="cs-iconbox_subtitle">Sed ut perspiciatis unde omnis iste natus error voluptatem accusantium also a
          doloremque laudantium, totam remain beatae vitae dictaro enim ipsam sunt explicabo.</div>
      </div>
      <div class="cs-height_30 cs-height_lg_35"></div>
    ...
    <div class="col-lg-46">
      <div class="cs-iconbox cs-style2 text-center">
        <div class="cs-iconbox_icon">
          <img src="assets/img/fb-icon.png"></img>
        </div>
        <h2 class="cs-iconbox_title"><a href="Facebook.php">Facebook</a></h2>
        <div class="cs-iconbox_subtitle">Sed ut perspiciatis unde omnis iste natus error voluptatem accusantium also a
          doloremque laudantium, totam remain beatae vitae dictaro enim ipsam sunt explicabo.</div>
      </div>
      <div class="cs-height_30 cs-height_lg_35"></div>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-47">
      <div class="cs-iconbox cs-style2 text-center">
        <div class="cs-iconbox_icon">
          <img src="assets/img/linkedin-icon.png"></img>
        </div>
        <h2 class="cs-iconbox_title"><a href="Linkedin.php">LinkedIn</a></h2>
        <div class="cs-iconbox_subtitle">Sed ut perspiciatis unde omnis iste natus error voluptatem accusantium also a
          doloremque laudantium, totam remain beatae vitae dictaro enim ipsam sunt explicabo.</div>
      </div>
      <div class="cs-height_30 cs-height_lg_35"></div>
    ...
    <div class="col-lg-48">
      <div class="cs-iconbox cs-style2 text-center">
        <div class="cs-iconbox_icon">
          <img src="assets/img/Whatsapp-Icon.png"></img>
        </div>
        <h2 class="cs-iconbox_title"> <a href="whatsapp.php">WhatsApp</a></h2>
        <div class="cs-iconbox_subtitle">Sed ut perspiciatis unde omnis iste natus error voluptatem accusantium also a
          doloremque laudantium, totam remain beatae vitae dictaro enim ipsam sunt explicabo.</div>
      </div>
      <div class="cs-height_30 cs-height_lg_35"></div>
    ...
    <div class="col-lg-49">
      <div class="cs-iconbox cs-style2 text-center">
        <img src="assets/img/twitter-icon.png"></img>
        <h2 class="cs-iconbox_title"><a href="Twitter.php">Twitter</a></h2>
        <div class="cs-iconbox_subtitle">Sed ut perspiciatis unde omnis iste natus error voluptatem accusantium also a
          doloremque laudantium, totam remain beatae vitae dictaro enim ipsam sunt explicabo.</div>
      </div>
      <div class="cs-height_30 cs-height_lg_35"></div>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-50">
      <div class="cs-iconbox cs-style2 text-center">
       <img src="assets/img/spotify-icon.png"></img>
        <h2 class="cs-iconbox_title"><a href="spotify.php">Spotify</a></h2>
        <div class="cs-iconbox_subtitle">Sed ut perspiciatis unde omnis iste natus error voluptatem accusantium also a
          doloremque laudantium, totam remain beatae vitae dictaro enim ipsam sunt explicabo.</div>
      </div>
      <div class="cs-height_30 cs-height_lg_35"></div>
    ...
    <div class="col-lg-52">
      <div class="cs-iconbox cs-style2 text-center">
       <img src="assets/img/snapchat-icon.png"></img>
        <h2 class="cs-iconbox_title"><a href="snapchat.php">Snapchat</a></h2>
        <div class="cs-iconbox_subtitle">Sed ut perspiciatis unde omnis iste natus error voluptatem accusantium also a
          doloremque laudantium, totam remain beatae vitae dictaro enim ipsam sunt explicabo.</div>
      </div>
      <div class="cs-height_30 cs-height_lg_35"></div>
    ...
    <div class="col-lg-53">
      <div class="cs-iconbox cs-style2 text-center">
       <img src="assets/img/tiktok-icon.png"></img>
        <h2 class="cs-iconbox_title"><a href="tiktok.php">Tiktok</a></h2>
        <div class="cs-iconbox_subtitle">Sed ut perspiciatis unde omnis iste natus error voluptatem accusantium also a
          doloremque laudantium, totam remain beatae vitae dictaro enim ipsam sunt explicabo.</div>
      </div>
      <div class="cs-height_30 cs-height_lg_35"></div>
  ...
  <div class="row">
    <div class="col-lg-54">
      <div class="cs-iconbox cs-style2 text-center">
        ...
        <img src="assets/img/pinterest Icon.png"></img>
        <h2 class="cs-iconbox_title"><a href="pinterest.php">Pinterest</a></h2>
        <div class="cs-iconbox_subtitle">Sed ut perspiciatis unde omnis iste natus error voluptatem accusantium also a
          doloremque laudantium, totam remain beatae vitae dictaro enim ipsam sunt explicabo.</div>
      </div>
      <div class="cs-height_30 cs-height_lg_35"></div>
    ...
    <div class="col-lg-55">
      <div class="cs-iconbox cs-style2 text-center">
       <img src="assets/img/tumbler-icon.png"></img>
        <h2 class="cs-iconbox_title"><a href="tumbler.php">Tumbler</a></h2>
        <div class="cs-iconbox_subtitle">Sed ut perspiciatis unde omnis iste natus error voluptatem accusantium also a
          doloremque laudantium, totam remain beatae vitae dictaro enim ipsam sunt explicabo.</div>
      </div>
      <div class="cs-height_30 cs-height_lg_35"></div>
