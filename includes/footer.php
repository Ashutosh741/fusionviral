      ...
      <div class="cs-fooer_main">
        <div class="container">
          <div class="row">
            <div class="col-lg-3 col-sm-6">
              <div class="cs-footer_item">
                <div class="cs-text_widget">
                  <img src="assets/img/Fusion Viral Logo.png" alt="Thumb">
                  <p> Welcome to arino sed ut perspiciae omunde omnis iste natus error sitort voluptatem accusantium. </p>
                </div>
                <div class="cs-social_btns cs-style1">
                  <a href="https://www.instagram.com/_fusionviral/" class="cs-center">
            ...
            <div class="col-lg-3 col-sm-6">
              <div class="cs-footer_item">
                <h2 class="cs-widget_title">Top Services</h2>
                <ul class="cs-menu_widget cs-mp0">
                      <li>
                        <a href="Youtube.php">Youtube Promotion</a>
                      </li>
                      <li>
                        <a href="Instagram.php">Instagram Promotion</a>
                      </li>
                      <li>
                        <a href="Facebook.php">Facebook Promotion</a>
                      </li>
                      <li>
                        <a href="Linkedin.php">Linkedin Promotion</a>
                      </li>
                      <li>
                        <a href="whatsapp.php">WhatsApp Promotion</a>
                      </li>
                </ul>
              </div>
            </div>
            <div class="col-lg-3 col-sm-6">
              <div class="cs-footer_item">
                <h2 class="cs-widget_title">Most Picked services</h2>
                <ul class="cs-menu_widget cs-mp0">
                      <li>
      ...
      <div class="container">
        <div class="cs-bottom_footer">
          <div class="cs-bottom_footer_left">
            <div class="cs-copyright">Copyright © 2023 Fusion Viral</div>
          </div>
